  ...
  return (
    <Section tint>
      <div className="container-page">
        ...
        <div className="mx-auto mt-12 grid max-w-5xl gap-10 lg:grid-cols-[0.82fr_1.18fr] lg:items-start lg:gap-14">
          {/* The first quiet evening of doing the work, herself */}
          <SectionMedia
            src="/Section-Images/section-image8.png"
            alt="A woman starting the work at her laptop, at ease"
